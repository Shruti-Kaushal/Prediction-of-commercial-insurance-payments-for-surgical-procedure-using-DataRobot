...
tka_2020_data <- inner_join(tka_2020_data, msa_geo, by=c("msa" = "GEOID"))
...
per_capita_income_data <- inner_join(per_capita_income_data, msa_geo, by=c("ï..Metropolitan.Statistical.Area" = "NAME"))
