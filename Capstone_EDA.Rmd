...
Even working with a relatively complete dataset, there is still a significant quantity of missing data, and observing any overarching trend appears a difficult task. Lastly, we will take a look at the number of hospitals present in each MSA.
